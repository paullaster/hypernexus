...
<pre><code class="js"><span class="hl-1">if</span><span class="hl-2"> (</span><span class="hl-3">process</span><span class="hl-2">.</span><span class="hl-3">argv</span><span class="hl-2">[</span><span class="hl-9">2</span><span class="hl-2">] === </span><span class="hl-4">&#39;child&#39;</span><span class="hl-2">) {</span><br/><span class="hl-2">  </span><span class="hl-7">setTimeout</span><span class="hl-2">(() </span><span class="hl-0">=&gt;</span><span class="hl-2"> {</span><br/><span class="hl-2">    </span><span class="hl-3">console</span><span class="hl-2">.</span><span class="hl-7">log</span><span class="hl-2">(</span><span class="hl-4">`Hello from </span><span class="hl-0">${</span><span class="hl-3">process</span><span class="hl-8">.</span><span class="hl-3">argv</span><span class="hl-8">[</span><span class="hl-9">2</span><span class="hl-8">]</span><span class="hl-0">}</span><span class="hl-4">!`</span><span class="hl-2">);</span><br/><span class="hl-2">  }, </span><span class="hl-9">1_000</span><span class="hl-2">);</span><br/><span class="hl-2">} </span><span class="hl-1">else</span><span class="hl-2"> {</span><br/><span class="hl-2">  </span><span class="hl-1">import</span><span class="hl-2"> { </span><span class="hl-3">fork</span><span class="hl-2"> } </span><span class="hl-1">from</span><span class="hl-2"> </span><span class="hl-4">&#39;node:child_process&#39;</span><span class="hl-2">;</span><br/><span class="hl-2">  </span><span class="hl-0">const</span><span class="hl-2"> </span><span class="hl-5">controller</span><span class="hl-2"> = </span><span class="hl-0">new</span><span class="hl-2"> </span><span class="hl-7">AbortController</span><span class="hl-2">();</span><br/><span class="hl-2">  </span><span class="hl-0">const</span><span class="hl-2"> { </span><span class="hl-5">signal</span><span class="hl-2"> } = </span><span class="hl-3">controller</span><span class="hl-2">;</span><br/><span class="hl-2">  </span><span class="hl-0">const</span><span class="hl-2"> </span><span class="hl-5">child</span><span class="hl-2"> = </span><span class="hl-7">fork</span><span class="hl-2">(</span><span class="hl-3">__filename</span><span class="hl-2">, [</span><span class="hl-4">&#39;child&#39;</span><span class="hl-2">], { </span><span class="hl-3">signal</span><span class="hl-2"> });</span><br/><span class="hl-2">  </span><span class="hl-3">child</span><span class="hl-2">.</span><span class="hl-7">on</span><span class="hl-2">(</span><span class="hl-4">&#39;error&#39;</span><span class="hl-2">, (</span><span class="hl-3">err</span><span class="hl-2">) </span><span class="hl-0">=&gt;</span><span class="hl-2"> {</span><br/><span class="hl-2">    </span><span class="hl-6">// This will be called with err being an AbortError if the controller aborts</span><br/><span class="hl-2">  });</span><br/><span class="hl-2">  </span><span class="hl-3">controller</span><span class="hl-2">.</span><span class="hl-7">abort</span><span class="hl-2">(); </span><span class="hl-6">// Stops the child process</span><br/><span class="hl-2">}</span>
