...
<pre><code class="js"><span class="hl-7">import</span><span class="hl-2"> </span><span class="hl-1">vm</span><span class="hl-2"> </span><span class="hl-7">from</span><span class="hl-2"> </span><span class="hl-4">&#39;node:vm&#39;</span><span class="hl-2">;</span><br/><br/><span class="hl-5">const</span><span class="hl-2"> </span><span class="hl-6">contextifiedObject</span><span class="hl-2"> = </span><span class="hl-1">vm</span><span class="hl-2">.</span><span class="hl-3">createContext</span><span class="hl-2">({</span><br/><span class="hl-2">  </span><span class="hl-1">secret:</span><span class="hl-2"> </span><span class="hl-23">42</span><span class="hl-2">,</span><br/><span class="hl-2">  </span><span class="hl-1">print:</span><span class="hl-2"> </span><span class="hl-1">console</span><span class="hl-2">.</span><span class="hl-1">log</span><span class="hl-2">,</span><br/><span class="hl-2">});</span><br/><br/><span class="hl-0">// Step 1</span><br/><span class="hl-0">//</span><br/><span class="hl-0">// Create a Module by constructing a new `vm.SourceTextModule` object. This</span><br/><span class="hl-0">// parses the provided source text, throwing a `SyntaxError` if anything goes</span><br/><span class="hl-0">// wrong. By default, a Module is created in the top context. But here, we</span><br/><span class="hl-0">// specify `contextifiedObject` as the context this Module belongs to.</span><br/><span class="hl-0">//</span><br/><span class="hl-0">// Here, we attempt to obtain the default export from the module &quot;foo&quot;, and</span><br/><span class="hl-0">// put it into local binding &quot;secret&quot;.</span><br/><br/><span class="hl-5">const</span><span class="hl-2"> </span><span class="hl-6">bar</span><span class="hl-2"> = </span><span class="hl-5">new</span><span class="hl-2"> </span><span class="hl-1">vm</span><span class="hl-2">.</span><span class="hl-3">SourceTextModule</span><span class="hl-2">(</span><span class="hl-4">`</span><br/><span class="hl-4">  import s from &#39;foo&#39;;</span><br/><span class="hl-4">  s;</span><br/><span class="hl-4">  print(s);</span><br/><span class="hl-4">`</span><span class="hl-2">, { </span><span class="hl-1">context:</span><span class="hl-2"> </span><span class="hl-1">contextifiedObject</span><span class="hl-2"> });</span><br/><br/><span class="hl-0">// Step 2</span><br/><span class="hl-0">//</span><br/><span class="hl-0">// &quot;Link&quot; the imported dependencies of this Module to it.</span><br/><span class="hl-0">//</span><br/><span class="hl-0">// The provided linking callback (the &quot;linker&quot;) accepts two arguments: the</span><br/><span class="hl-0">// parent module (`bar` in this case) and the string that is the specifier of</span><br/><span class="hl-0">// the imported module. The callback is expected to return a Module that</span><br/><span class="hl-0">// corresponds to the provided specifier, with certain requirements documented</span><br/><span class="hl-0">// in `module.link()`.</span><br/><span class="hl-0">//</span><br/><span class="hl-0">// If linking has not started for the returned Module, the same linker</span><br/><span class="hl-0">// callback will be called on the returned Module.</span><br/><span class="hl-0">//</span><br/><span class="hl-0">// Even top-level Modules without dependencies must be explicitly linked. The</span><br/><span class="hl-0">// callback provided would never be called, however.</span><br/><span class="hl-0">//</span><br/><span class="hl-0">// The link() method returns a Promise that will be resolved when all the</span><br/><span class="hl-0">// Promises returned by the linker resolve.</span><br/><span class="hl-0">//</span><br/><span class="hl-0">// Note: This is a contrived example in that the linker function creates a new</span><br/><span class="hl-0">// &quot;foo&quot; module every time it is called. In a full-fledged module system, a</span><br/><span class="hl-0">// cache would probably be used to avoid duplicated modules.</span><br/><br/><span class="hl-5">async</span><span class="hl-2"> </span><span class="hl-5">function</span><span class="hl-2"> </span><span class="hl-3">linker</span><span class="hl-2">(</span><span class="hl-1">specifier</span><span class="hl-2">, </span><span class="hl-1">referencingModule</span><span class="hl-2">) {</span><br/><span class="hl-2">  </span><span class="hl-7">if</span><span class="hl-2"> (</span><span class="hl-1">specifier</span><span class="hl-2"> === </span><span class="hl-4">&#39;foo&#39;</span><span class="hl-2">) {</span><br/><span class="hl-2">    </span><span class="hl-7">return</span><span class="hl-2"> </span><span class="hl-5">new</span><span class="hl-2"> </span><span class="hl-1">vm</span><span class="hl-2">.</span><span class="hl-3">SourceTextModule</span><span class="hl-2">(</span><span class="hl-4">`</span><br/><span class="hl-4">      // The &quot;secret&quot; variable refers to the global variable we added to</span><br/><span class="hl-4">      // &quot;contextifiedObject&quot; when creating the context.</span><br/><span class="hl-4">      export default secret;</span><br/><span class="hl-4">    `</span><span class="hl-2">, { </span><span class="hl-1">context:</span><span class="hl-2"> </span><span class="hl-1">referencingModule</span><span class="hl-2">.</span><span class="hl-1">context</span><span class="hl-2"> });</span><br/><br/><span class="hl-2">    </span><span class="hl-0">// Using `contextifiedObject` instead of `referencingModule.context`</span><br/><span class="hl-2">    </span><span class="hl-0">// here would work as well.</span><br/><span class="hl-2">  }</span><br/><span class="hl-2">  </span><span class="hl-7">throw</span><span class="hl-2"> </span><span class="hl-5">new</span><span class="hl-2"> </span><span class="hl-3">Error</span><span class="hl-2">(</span><span class="hl-4">`Unable to resolve dependency: </span><span class="hl-5">${</span><span class="hl-1">specifier</span><span class="hl-5">}</span><span class="hl-4">`</span><span class="hl-2">);</span><br/><span class="hl-2">}</span><br/><span class="hl-7">await</span><span class="hl-2"> </span><span class="hl-1">bar</span><span class="hl-2">.</span><span class="hl-3">link</span><span class="hl-2">(</span><span class="hl-1">linker</span><span class="hl-2">);</span><br/><br/><span class="hl-0">// Step 3</span><br/><span class="hl-0">//</span><br/><span class="hl-0">// Evaluate the Module. The evaluate() method returns a promise which will</span><br/><span class="hl-0">// resolve after the module has finished evaluating.</span><br/><br/><span class="hl-0">// Prints 42.</span><br/><span class="hl-7">await</span><span class="hl-2"> </span><span class="hl-1">bar</span><span class="hl-2">.</span><span class="hl-3">evaluate</span><span class="hl-2">();</span>
