...
<pre><code class="js"><span class="hl-7">import</span><span class="hl-2"> </span><span class="hl-1">http</span><span class="hl-2"> </span><span class="hl-7">from</span><span class="hl-2"> </span><span class="hl-4">&#39;node:http&#39;</span><span class="hl-2">;</span><br/><span class="hl-7">import</span><span class="hl-2"> { </span><span class="hl-1">AsyncLocalStorage</span><span class="hl-2"> } </span><span class="hl-7">from</span><span class="hl-2"> </span><span class="hl-4">&#39;node:async_hooks&#39;</span><span class="hl-2">;</span><br/><br/><span class="hl-5">const</span><span class="hl-2"> </span><span class="hl-6">asyncLocalStorage</span><span class="hl-2"> = </span><span class="hl-5">new</span><span class="hl-2"> </span><span class="hl-3">AsyncLocalStorage</span><span class="hl-2">();</span><br/><br/><span class="hl-5">function</span><span class="hl-2"> </span><span class="hl-3">logWithId</span><span class="hl-2">(</span><span class="hl-1">msg</span><span class="hl-2">) {</span><br/><span class="hl-2">  </span><span class="hl-5">const</span><span class="hl-2"> </span><span class="hl-6">id</span><span class="hl-2"> = </span><span class="hl-1">asyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">getStore</span><span class="hl-2">();</span><br/><span class="hl-2">  </span><span class="hl-1">console</span><span class="hl-2">.</span><span class="hl-3">log</span><span class="hl-2">(</span><span class="hl-4">`</span><span class="hl-5">${</span><span class="hl-1">id</span><span class="hl-27"> </span><span class="hl-2">!==</span><span class="hl-27"> </span><span class="hl-5">undefined</span><span class="hl-27"> </span><span class="hl-2">?</span><span class="hl-27"> </span><span class="hl-1">id</span><span class="hl-27"> </span><span class="hl-2">:</span><span class="hl-27"> </span><span class="hl-4">&#39;-&#39;</span><span class="hl-5">}</span><span class="hl-4">:`</span><span class="hl-2">, </span><span class="hl-1">msg</span><span class="hl-2">);</span><br/><span class="hl-2">}</span><br/><br/><span class="hl-5">let</span><span class="hl-2"> </span><span class="hl-1">idSeq</span><span class="hl-2"> = </span><span class="hl-23">0</span><span class="hl-2">;</span><br/><span class="hl-1">http</span><span class="hl-2">.</span><span class="hl-3">createServer</span><span class="hl-2">((</span><span class="hl-1">req</span><span class="hl-2">, </span><span class="hl-1">res</span><span class="hl-2">) </span><span class="hl-5">=&gt;</span><span class="hl-2"> {</span><br/><span class="hl-2">  </span><span class="hl-1">asyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">run</span><span class="hl-2">(</span><span class="hl-1">idSeq</span><span class="hl-2">++, () </span><span class="hl-5">=&gt;</span><span class="hl-2"> {</span><br/><span class="hl-2">    </span><span class="hl-3">logWithId</span><span class="hl-2">(</span><span class="hl-4">&#39;start&#39;</span><span class="hl-2">);</span><br/><span class="hl-2">    </span><span class="hl-0">// Imagine any chain of async operations here</span><br/><span class="hl-2">    </span><span class="hl-3">setImmediate</span><span class="hl-2">(() </span><span class="hl-5">=&gt;</span><span class="hl-2"> {</span><br/><span class="hl-2">      </span><span class="hl-3">logWithId</span><span class="hl-2">(</span><span class="hl-4">&#39;finish&#39;</span><span class="hl-2">);</span><br/><span class="hl-2">      </span><span class="hl-1">res</span><span class="hl-2">.</span><span class="hl-3">end</span><span class="hl-2">();</span><br/><span class="hl-2">    });</span><br/><span class="hl-2">  });</span><br/><span class="hl-2">}).</span><span class="hl-3">listen</span><span class="hl-2">(</span><span class="hl-23">8080</span><span class="hl-2">);</span><br/><br/><span class="hl-1">http</span><span class="hl-2">.</span><span class="hl-3">get</span><span class="hl-2">(</span><span class="hl-4">&#39;http://localhost:8080&#39;</span><span class="hl-2">);</span><br/><span class="hl-1">http</span><span class="hl-2">.</span><span class="hl-3">get</span><span class="hl-2">(</span><span class="hl-4">&#39;http://localhost:8080&#39;</span><span class="hl-2">);</span><br/><span class="hl-0">// Prints:</span><br/><span class="hl-0">//   0: start</span><br/><span class="hl-0">//   1: start</span><br/><span class="hl-0">//   0: finish</span><br/><span class="hl-0">//   1: finish</span>
...
<p>Example:</p>
<pre><code class="js"><span class="hl-5">const</span><span class="hl-2"> </span><span class="hl-6">store</span><span class="hl-2"> = { </span><span class="hl-1">id:</span><span class="hl-2"> </span><span class="hl-23">1</span><span class="hl-2"> };</span><br/><span class="hl-0">// Replaces previous store with the given store object</span><br/><span class="hl-1">asyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">enterWith</span><span class="hl-2">(</span><span class="hl-1">store</span><span class="hl-2">);</span><br/><span class="hl-1">asyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">getStore</span><span class="hl-2">(); </span><span class="hl-0">// Returns the store object</span><br/><span class="hl-3">someAsyncOperation</span><span class="hl-2">(() </span><span class="hl-5">=&gt;</span><span class="hl-2"> {</span><br/><span class="hl-2">  </span><span class="hl-1">asyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">getStore</span><span class="hl-2">(); </span><span class="hl-0">// Returns the same object</span><br/><span class="hl-2">});</span>
</code><button type="button">Copy</button></pre>
...
<pre><code class="js"><span class="hl-5">const</span><span class="hl-2"> </span><span class="hl-6">store</span><span class="hl-2"> = { </span><span class="hl-1">id:</span><span class="hl-2"> </span><span class="hl-23">1</span><span class="hl-2"> };</span><br/><br/><span class="hl-1">emitter</span><span class="hl-2">.</span><span class="hl-3">on</span><span class="hl-2">(</span><span class="hl-4">&#39;my-event&#39;</span><span class="hl-2">, () </span><span class="hl-5">=&gt;</span><span class="hl-2"> {</span><br/><span class="hl-2">  </span><span class="hl-1">asyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">enterWith</span><span class="hl-2">(</span><span class="hl-1">store</span><span class="hl-2">);</span><br/><span class="hl-2">});</span><br/><span class="hl-1">emitter</span><span class="hl-2">.</span><span class="hl-3">on</span><span class="hl-2">(</span><span class="hl-4">&#39;my-event&#39;</span><span class="hl-2">, () </span><span class="hl-5">=&gt;</span><span class="hl-2"> {</span><br/><span class="hl-2">  </span><span class="hl-1">asyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">getStore</span><span class="hl-2">(); </span><span class="hl-0">// Returns the same object</span><br/><span class="hl-2">});</span><br/><br/><span class="hl-1">asyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">getStore</span><span class="hl-2">(); </span><span class="hl-0">// Returns undefined</span><br/><span class="hl-1">emitter</span><span class="hl-2">.</span><span class="hl-3">emit</span><span class="hl-2">(</span><span class="hl-4">&#39;my-event&#39;</span><span class="hl-2">);</span><br/><span class="hl-1">asyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">getStore</span><span class="hl-2">(); </span><span class="hl-0">// Returns the same object</span>
</code><button type="button">Copy</button></pre>
...
<p>Example:</p>
<pre><code class="js"><span class="hl-0">// Within a call to run</span><br/><span class="hl-7">try</span><span class="hl-2"> {</span><br/><span class="hl-2">  </span><span class="hl-1">asyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">getStore</span><span class="hl-2">(); </span><span class="hl-0">// Returns the store object or value</span><br/><span class="hl-2">  </span><span class="hl-1">asyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">exit</span><span class="hl-2">(() </span><span class="hl-5">=&gt;</span><span class="hl-2"> {</span><br/><span class="hl-2">    </span><span class="hl-1">asyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">getStore</span><span class="hl-2">(); </span><span class="hl-0">// Returns undefined</span><br/><span class="hl-2">    </span><span class="hl-7">throw</span><span class="hl-2"> </span><span class="hl-5">new</span><span class="hl-2"> </span><span class="hl-3">Error</span><span class="hl-2">();</span><br/><span class="hl-2">  });</span><br/><span class="hl-2">} </span><span class="hl-7">catch</span><span class="hl-2"> (</span><span class="hl-1">e</span><span class="hl-2">) {</span><br/><span class="hl-2">  </span><span class="hl-1">asyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">getStore</span><span class="hl-2">(); </span><span class="hl-0">// Returns the same object or value</span><br/><span class="hl-2">  </span><span class="hl-0">// The error will be caught here</span><br/><span class="hl-2">}</span>
</code><button type="button">Copy</button></pre>
...
<p>Example:</p>
<pre><code class="js"><span class="hl-5">const</span><span class="hl-2"> </span><span class="hl-6">store</span><span class="hl-2"> = { </span><span class="hl-1">id:</span><span class="hl-2"> </span><span class="hl-23">2</span><span class="hl-2"> };</span><br/><span class="hl-7">try</span><span class="hl-2"> {</span><br/><span class="hl-2">  </span><span class="hl-1">asyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">run</span><span class="hl-2">(</span><span class="hl-1">store</span><span class="hl-2">, () </span><span class="hl-5">=&gt;</span><span class="hl-2"> {</span><br/><span class="hl-2">    </span><span class="hl-1">asyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">getStore</span><span class="hl-2">(); </span><span class="hl-0">// Returns the store object</span><br/><span class="hl-2">    </span><span class="hl-3">setTimeout</span><span class="hl-2">(() </span><span class="hl-5">=&gt;</span><span class="hl-2"> {</span><br/><span class="hl-2">      </span><span class="hl-1">asyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">getStore</span><span class="hl-2">(); </span><span class="hl-0">// Returns the store object</span><br/><span class="hl-2">    }, </span><span class="hl-23">200</span><span class="hl-2">);</span><br/><span class="hl-2">    </span><span class="hl-7">throw</span><span class="hl-2"> </span><span class="hl-5">new</span><span class="hl-2"> </span><span class="hl-3">Error</span><span class="hl-2">();</span><br/><span class="hl-2">  });</span><br/><span class="hl-2">} </span><span class="hl-7">catch</span><span class="hl-2"> (</span><span class="hl-1">e</span><span class="hl-2">) {</span><br/><span class="hl-2">  </span><span class="hl-1">asyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">getStore</span><span class="hl-2">(); </span><span class="hl-0">// Returns undefined</span><br/><span class="hl-2">  </span><span class="hl-0">// The error will be caught here</span><br/><span class="hl-2">}</span>
</code><button type="button">Copy</button></pre>
...
<pre><code class="js"><span class="hl-5">const</span><span class="hl-2"> </span><span class="hl-6">asyncLocalStorage</span><span class="hl-2"> = </span><span class="hl-5">new</span><span class="hl-2"> </span><span class="hl-3">AsyncLocalStorage</span><span class="hl-2">();</span><br/><span class="hl-5">const</span><span class="hl-2"> </span><span class="hl-6">runInAsyncScope</span><span class="hl-2"> = </span><span class="hl-1">asyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">run</span><span class="hl-2">(</span><span class="hl-23">123</span><span class="hl-2">, () </span><span class="hl-5">=&gt;</span><span class="hl-2"> </span><span class="hl-1">AsyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">snapshot</span><span class="hl-2">());</span><br/><span class="hl-5">const</span><span class="hl-2"> </span><span class="hl-6">result</span><span class="hl-2"> = </span><span class="hl-1">asyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">run</span><span class="hl-2">(</span><span class="hl-23">321</span><span class="hl-2">, () </span><span class="hl-5">=&gt;</span><span class="hl-2"> </span><span class="hl-3">runInAsyncScope</span><span class="hl-2">(() </span><span class="hl-5">=&gt;</span><span class="hl-2"> </span><span class="hl-1">asyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">getStore</span><span class="hl-2">()));</span><br/><span class="hl-1">console</span><span class="hl-2">.</span><span class="hl-3">log</span><span class="hl-2">(</span><span class="hl-1">result</span><span class="hl-2">);  </span><span class="hl-0">// returns 123</span>
</code><button type="button">Copy</button></pre>
...
<pre><code class="js"><span class="hl-5">class</span><span class="hl-2"> </span><span class="hl-8">Foo</span><span class="hl-2"> {</span><br/><span class="hl-2">  </span><span class="hl-1">#runInAsyncScope</span><span class="hl-2"> = </span><span class="hl-1">AsyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">snapshot</span><span class="hl-2">();</span><br/><br/><span class="hl-2">  </span><span class="hl-3">get</span><span class="hl-2">() { </span><span class="hl-7">return</span><span class="hl-2"> </span><span class="hl-5">this</span><span class="hl-2">.</span><span class="hl-3">#runInAsyncScope</span><span class="hl-2">(() </span><span class="hl-5">=&gt;</span><span class="hl-2"> </span><span class="hl-1">asyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">getStore</span><span class="hl-2">()); }</span><br/><span class="hl-2">}</span><br/><br/><span class="hl-5">const</span><span class="hl-2"> </span><span class="hl-6">foo</span><span class="hl-2"> = </span><span class="hl-1">asyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">run</span><span class="hl-2">(</span><span class="hl-23">123</span><span class="hl-2">, () </span><span class="hl-5">=&gt;</span><span class="hl-2"> </span><span class="hl-5">new</span><span class="hl-2"> </span><span class="hl-3">Foo</span><span class="hl-2">());</span><br/><span class="hl-1">console</span><span class="hl-2">.</span><span class="hl-3">log</span><span class="hl-2">(</span><span class="hl-1">asyncLocalStorage</span><span class="hl-2">.</span><span class="hl-3">run</span><span class="hl-2">(</span><span class="hl-23">321</span><span class="hl-2">, () </span><span class="hl-5">=&gt;</span><span class="hl-2"> </span><span class="hl-1">foo</span><span class="hl-2">.</span><span class="hl-3">get</span><span class="hl-2">())); </span><span class="hl-0">// returns 123</span>
</code><button type="button">Copy</button></pre>
